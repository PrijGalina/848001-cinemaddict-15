...
const genreArray = ['Drama', 'Comedy', 'Musical', 'Romance', 'Romantic comedy', 'Detective', 'Crime', 'Action', 'Thriller', 'Horror', 'Animated', 'Cartoon', 'Science fiction', 'Fantasy', 'Documentary', 'Silent movie', 'Western', 'Art-house', 'Short', 'Underground'];
...
export {arrayMovieInfo, workingGroup, ageRestrictionsArray, countryArray, genreArray, descriptionTextArray};
